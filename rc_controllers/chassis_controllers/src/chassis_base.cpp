...
bool ChassisBase::init(hardware_interface::RobotHW* robot_hw, ros::NodeHandle& root_nh, ros::NodeHandle& controller_nh)
{
  ...
  cmd_chassis_sub_ =
      controller_nh.subscribe<rc_msgs::ChassisCmd>("cmd_chassis", 1, &ChassisBase::cmdChassisCallback, this);
...
void ChassisBase::cmdChassisCallback(const rc_msgs::ChassisCmd::ConstPtr& msg)
{
